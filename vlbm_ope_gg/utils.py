...
def rollout_original_env(policy, MAX_EPISODE_LEN=3, GAMMA=0.995, REPEAT=1): # From original environment
...
def generate_and_check_trajectory(policies_and_envs, epsilon):
    ...
    b_r, b_t, b_a = rollout_original_env(behavior_policy, original_env)
    t_r, t_t, t_a = rollout_original_env(target_policy, learned_env)
#### key component
